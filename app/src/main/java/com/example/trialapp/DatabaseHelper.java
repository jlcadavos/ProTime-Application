...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<ScheduleDataModel> getAllData() {
        ArrayList<ScheduleDataModel> arrayList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            ScheduleDataModel dataModel = new ScheduleDataModel(title, date, time);
